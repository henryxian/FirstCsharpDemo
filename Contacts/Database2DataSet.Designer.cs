...
namespace Contacts.Database2DataSetTableAdapters {
...
SELECT ContactID, Name, Company, Telephone, Email, Client, LastCall FROM People WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Contacts.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        public virtual int Fill(Database2DataSet.PeopleDataTable dataTable) {
        ...
        public virtual Database2DataSet.PeopleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database2DataSet.PeopleDataTable dataTable = new Database2DataSet.PeopleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database2DataSet.PeopleDataTable dataTable) {
